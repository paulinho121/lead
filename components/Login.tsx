                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="relative my-6">
                            ...
                            <div className="relative flex justify-center text-[10px] font-black uppercase tracking-widest">
                                <span className="px-4 bg-[var(--bg-card)] text-[var(--text-muted)]">Ou entrar com</span>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full bg-white dark:bg-[#1a1d23] border border-[var(--border)] text-[var(--text-main)] py-4 rounded-2xl font-bold text-sm shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
                        >
